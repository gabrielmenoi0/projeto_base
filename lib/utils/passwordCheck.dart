    ...
    return Column(
      ...
      children: [
        Text(
          ...
          style: DefaultStyle.textStyle(size: 14, fontWeight: FontWeight.w500),
        ),
  ...
  Widget _icon(bool isOk) {
    if (isOk) {
      return const Icon(Icons.check_circle_outline,
          size: 24, color: DefaultColors.successColor);
    }

    return const Icon(Icons.radio_button_unchecked_sharp,
        size: 24, color: DefaultColors.dangerColor);
  }
